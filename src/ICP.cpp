 ...
 * @LastEditTime: 2022-04-28 17:00:33
...
ICP::ICP(const float max_correspondence, const int max_iteration, const float max_mse_difference, const float max_tranformation_diference)
    : kCorrespondenceThreshold{ max_correspondence }, kIterationThreshold{ max_iteration }, kMSEThreshold{ max_mse_difference }, kTransformationThreshold{ max_tranformation_diference },
      regist_base() {}
